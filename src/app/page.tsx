...
import { Sparkles, PenTool, PlayCircle, PauseCircle, Mic, Leaf } from 'lucide-react'; // Removed unused: Clock, Bird, Cloud, Headphones
...
// Define the Step component (can be moved to its own file if preferred)
...
export default function Home() { // Changed from React.FC
 ...
 return (
  // Removed redundant outer div, assuming layout provides structure
  <>
   {/* Hero Section */}
   ...
   <section id="how-it-works" className="py-20 bg-white scroll-mt-20">
    <div className="container mx-auto px-6">
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 items-start">
      <Step num={1} title="Outline Your Story" Icon={PenTool} bg="bg-[#D6F4FF]" color="text-[#4FB8FF]" desc="Choose the theme, characters, and any educational focus for your story (length is ~3min)." />
      <Step num={2} title="Generate Story" Icon={Sparkles} bg="bg-[#E7FCEC]" color="text-[#06D6A0]" desc="Our AI crafts a unique story based on your input. Review and edit the text as needed. (First one's free!)" />
      <Step num={3} title="Add Voice" Icon={Mic} bg="bg-[#FFEAF2]" color="text-[#EF476F]" desc="Select a professional narrator (available now) or easily record your own voice (coming soon)" />
      <Step num={4} title="Enjoy!" Icon={PlayCircle} bg="bg-[#FFF5E7]" color="text-[#FF9F51]" desc="Listen to the narrated story with highlighting text and interactive elements in the Reading Room." />
     </div>
   ...
   <section className="py-20 bg-[#F2FCE2] relative overflow-hidden"> {/* Changed background */}
    <div className="container mx-auto px-6 relative z-10">
   ...
   {/* CTA Section */}
   <section className="py-20 bg-gradient-to-r from-[#4FB8FF] to-[#06D6A0] text-white relative overflow-hidden"> {/* Changed colors */}
    {/* Waves can be tricky, consider simplifying or using SVG background */}
    ...
    <div className="container mx-auto px-6 text-center relative z-10">
     ...
     <Link href={user ? "/create-story" : "/signup"}>
      <Button className="bg-white text-[#4FB8FF] hover:bg-white/90 font-medium text-lg px-8 py-3 rounded-full shadow-lg h-auto"> {/* Changed text color */}
